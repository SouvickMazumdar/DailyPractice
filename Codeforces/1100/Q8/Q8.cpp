...
/*
Problem Name: B. 2D Traveling
Problem Link: https://codeforces.com/problemset/problem/1869/B
Approach : Arrat and Implementation
*/
...
void solve() {
   ...
   cin>>n>>k>>a>>b;
   vpi vp(n);
   FOR(i,0,n)cin>>vp[i].first>>vp[i].second;
//    FOR(i,0,n)cout<<vp[i].first<<vp[i].second;
//    return;
    ll mini=1e18;
   ...
   else if(k>=a)
   {
        FOR(i,0,k)
        {
            mini=min(mini,abs(vp[b-1].first-vp[i].first) + abs(vp[b-1].second-vp[i].second));
        }
       cout<<mini<<endl;
   }
   else if(k>=b)
   {
     FOR(i,0,k)
        {
            mini=min(mini,abs(vp[a-1].first-vp[i].first) + abs(vp[a-1].second-vp[i].second));
        }
       cout<<mini<<endl;
   }
   else if(k<=1)
   ...
   else
   {
       ...
       FOR(i,0,k)
        ...
        ft+=mini;
        ll res;
        res=min(ft,abs(vp[a-1].first-vp[b-1].first) + abs(vp[a-1].second-vp[b-1].second));
        cout<<res<<endl;
   }
